...
# Meta as::build::date 2014-06-03
# Meta as::origin      http://sourceforge.net/projects/tcllib
# Meta category        Remote communication Remote communication
# Meta description     A remote communication facility for Tcl (8.3 and
# Meta description     later) The comm wire protocol
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.3}
# Meta require         snit
# Meta subject         socket send tls rpc communication secure
# Meta subject         {remote execution} {remote communication} ssl comm
# Meta subject         ipc message {remote execution} ipc comm socket rpc
# Meta subject         message {remote communication} communication
# Meta summary         comm comm_wire
# @@ Meta End
