...
# @@ Meta Begin
# Package cmdline 1.4
# Meta as::build::date 2014-12-03
# Meta as::origin      http://sourceforge.net/projects/tcllib
# Meta category        Command line and option processing
# Meta description     Procedures to process command lines and options.
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.2}
# Meta subject         {command line processing} argv0 argv
# Meta subject         {argument processing} {cmdline processing}
# Meta summary         cmdline
# @@ Meta End
