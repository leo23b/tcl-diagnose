...
# Meta description     Generator core for compiler of magic(5) files
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.4}
# Meta require         fileutil
# Meta require         fileutil::magic::cgen
# Meta require         fileutil::magic::rt
# Meta require         struct::list
# Meta subject         {file utilities} mime {file recognition} {file type}
# Meta subject         type
# Meta summary         fileutil::magic::cfront
# @@ Meta End
...
package require fileutil::magic::cgen
