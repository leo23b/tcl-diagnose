...
proc ::tkdnd::addType {name mime} {
   # ergänzt das tkDND-dict um einen DND_Typ <name> und mime
   # mime ist frei wählbar, muss bei target und source
   # übereinstimmen und in einem Programm eindeutig sein
   #-----------------------------------------------------------------------
