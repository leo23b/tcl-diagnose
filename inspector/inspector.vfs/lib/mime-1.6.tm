...
# @@ Meta Begin
# Package mime 1.6
# Meta as::build::date 2014-02-04
# Meta as::origin      http://sourceforge.net/projects/tcllib
# Meta category        Mime
# Meta description     Manipulation of MIME body parts
# Meta license         BSD
# Meta platform        tcl
# Meta recommend       {Trf 2.0}
# Meta require         {Tcl 8.5}
# Meta require         {base64 2.0}
# Meta require         md5
# Meta subject         smtp mime email internet {rfc 2049} {rfc 2045}
# Meta subject         {rfc 821} {rfc 2046} {rfc 822} net mail
# Meta summary         mime
# @@ Meta End
